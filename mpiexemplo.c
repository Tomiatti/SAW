// para compilar: mpicc mpiexemplo.c -o mpiexemplo -Wall
// para rodar: mpirun -np 2 mpiexemplo
...
int main(int argc, char** argv) {
       ...
       // int tamanhomatriz = lin*col/world_size;
        ...
        MPI_Scatter(matrizDados, lin*col/world_size, MPI_INT, &vetorResul, lin*col/world_size, MPI_INT, 0, MPI_COMM_WORLD);
        ...
        MPI_Gather(&vetorResul, lin, MPI_INT, matrizDados, lin, MPI_INT, 0, MPI_COMM_WORLD);
